...
function Search({searchResults }) {
    ...
    const formattedStartDate = format(new Date(sdate), "d MMMM yy");
    const formattedEndDate = format(new Date(edate), "d MMMM yy");
    ...
    <div className="h-screen">
        ...
        <main className="flex">
            <section className="flex-grow pt-14 px-6 ">
                <p className="text-xs">300+ stays - {range} - for {nofGuests} guests</p>
